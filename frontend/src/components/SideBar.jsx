...
import { MessageSquare, PanelLeftIcon, PanelRight, PenSquare, Plus, User, Coins, LogOut, Menu, X } from 'lucide-react'
...
const SideBar = () => {
  ...
  if (collapsed) {
    return (
        <div className='hidden lg:flex flex-col items-center w-14 h-screen bg-[#0d0f14] border-r border-white/6 py-4 gap-1 shrink-0'>
            ...
            <div className="realtive shrink-0">
                {
                    (userData?.avatar && !imageErr) ? 
                    <img src={userData?.avatar} alt={"User Img"} onError={()=>setImageError(true)}
  ...
  return (
    <>
        <button className='lg:hidden fixed top-3.5 left-4 z-50 flex items-center justify-center w-8 h-8 rounded-lg bg-[#0d0f14] border border-white/10 text-slate-400 hover:text-slate-... transition-colors duration-150 cursor-pointer'
        ...
        <div className={`fixed lg:static inset-y-0 left-0 z-50 w-67.5 h-screen shrink-0 bg-[#0d0f14] border-r border-white/0.06 transition-transform duration-250 ${mobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}>
            <div className='flex flex-col h-full'>
                <div className="flex items-center gap-2.5 px-4 py-4 border-b border-white/6">
                    ...
                    <span className="text-[16px] font-semibold text-slate-100 tracking-height flex-1">
                        CortexAI
                    </span>
                ...
                <div className="px-3.5 py-3.5">
                    {
                            ...
                            <div className="flex items-center gap-2.5 cursor-pointer rounded-xl px-3 py-2.5 hover:bg-white/5 transition-colors duration-150">
                                ...
                                <div className='flex gap-1'>
                                    <button
                                        ...
                                        hover:bg-white/8 hover:text-slate-400 transition-all duration-150'>
                                        <Coins size={16} />
                                    </button>
                        ...
                        <button
                            ...
                            text-slate-200 bg-white/5 border border-white/8
                            rounded-xl py-2.75 cursor-pointer
