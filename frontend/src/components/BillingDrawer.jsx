        ...
        { open && 
            <>
                ...
                <motion.div
                  ...
                  className="fixed right-0 top-0 z-50 h-screen w-[92vw] max-w-md bg-[#0f1117] border-l border-white/10 shadow-2xl flex flex-col sm:w-[420px]">
                    ...
                    <div className='px-4 sm:px-5 flex-1 overflow-auto space-y-4 pb-4'>
                        <div className='rounded-xl border border-white/10 p-4'>
                            ...
                            <button className='mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2.5 text-white'
